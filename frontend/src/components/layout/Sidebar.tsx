...
const navSections: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      { id: 'mission-control', label: 'Mission Control', icon: <Gauge size={18} /> },
      { id: 'cockpit', label: 'Cockpit', icon: <Radio size={18} /> },
      { id: 'token-economics', label: 'Token Economics', icon: <Zap size={18} /> },
      { id: 'session-timeline', label: 'Session Timeline', icon: <Clock size={18} /> },
      { id: 'extension-workshop', label: 'Extension Workshop', icon: <Wrench size={18} /> },
    ],
  },
  {
    title: 'Conversations',
    items: [
      ...
      { id: 'session-data', label: 'Session Data', icon: <FileText size={18} /> },
    ],
  },
  {
    title: 'Extensions',
    items: [
      { id: 'extensions', label: 'Extensions Hub', icon: <Puzzle size={18} /> },
